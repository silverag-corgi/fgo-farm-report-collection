...
def __get_args() -> argparse.Namespace:
    ...
    try:
        ...
        mutually_exclusive_group_b.add_argument(
            "-yu",
            "--merge_yearly_user_total_summary",
            action="store_true",
            help=help_,
        )
        ...
        mutually_exclusive_group_b.add_argument(
            "-yq",
            "--merge_yearly_quest_total_summary",
            action="store_true",
            help=help_,
        )
        ...
        mutually_exclusive_group_b.add_argument(
            "-mu",
            "--merge_monthly_user_total_summary",
            action="store_true",
            help=help_,
        )
        ...
        mutually_exclusive_group_b.add_argument(
            "-mq",
            "--merge_monthly_quest_total_summary",
            action="store_true",
            help=help_,
        )
        help_ = "周回報告個人概要マージ要否"
